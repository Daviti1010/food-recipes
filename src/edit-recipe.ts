...
const recipeId = params.get('meal_id');
...
async function getUserRecipeInstructions() {
    ...
    displayMealInstructions(recipe[0])
}


function displayMealInstructions(recipe: any) {
    ...
    originInput.value = recipe.origin;
    ...
    ytLinkInput.value = recipe.video;
